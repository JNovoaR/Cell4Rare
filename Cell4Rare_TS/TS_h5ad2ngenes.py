...
# singlecell_file_tissue.h5ad. FORMAT: h5ad; DESCRIPTION: single cell h5ad file from cell2gene belonging to an specific tissue/organ (f.e: skin)
...
# tissue_name. FORMAT: just a string; DESCRIPTION: name of the tissue/organ to wich the h5ad file belongs (case insensitive)
